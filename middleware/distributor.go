...
func SetupContextForSelectedChannel(c *gin.Context, channel *model.Channel, modelName string) *types.OpenCrabError {
	...
	key, index, openCrabError := channel.GetNextEnabledKey()
