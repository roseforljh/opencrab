...
import (
	...
	"github.com/QuantumNous/opencrab/pkg/cachex"
...
const (
	...
	channelAffinityCacheNamespace           = "opencrab:channel_affinity:v1"
	channelAffinityUsageCacheStatsNamespace = "opencrab:channel_affinity_usage_cache_stats:v1"
)
