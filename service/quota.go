...
func calculateAudioQuota(info QuotaInfo) int {
	...
	completionRatio := decimal.NewFromFloat(1)
	audioRatio := decimal.NewFromFloat(1)
	audioCompletionRatio := decimal.NewFromFloat(1)
...
func PostWssConsumeQuota(ctx *gin.Context, relayInfo *relaycommon.RelayInfo, modelName string,
	...
	if totalTokens == 0 {
		// in this case, some upstream error likely happened
		quota = 0
