...
export const dictionaries: Record<Language, Record<string, string>> = {
  "zh-CN": {
    ...
    "capabilities.title": "能力矩阵",
    "capabilities.description": "管理 provider 默认能力、渠道覆盖和模型画像，驱动中枢系统的约束求解。",
    "apikeys.title": "访问密钥",
  ...
  "en-US": {
    ...
    "capabilities.description": "Manage provider defaults, channel overrides, and model profiles for the capability solver.",
