...
const MessageContent = ({
  ...
  if (
    ...
    return (
      <div
        className={`${className} flex items-center gap-2 sm:gap-4 bg-gray-50 dark:bg-[#111]`}
      >
        <div className='w-5 h-5 rounded-full bg-gray-200 dark:bg-[#222] flex items-center justify-center shadow-lg border border-gray-300 dark:border-[#333]'>
          <Loader2
    ...
    <div className={className}>
      {message.role === 'system' && (
        <div className='mb-2 sm:mb-4'>
          <div
            className='flex items-center gap-2 p-2 sm:p-3 bg-gray-50 dark:bg-[#111] rounded-lg'
            style={{ border: '1px solid var(--semi-color-border)' }}
          >
            <div className='w-4 h-4 sm:w-5 sm:h-5 rounded-full bg-gray-200 dark:bg-[#222] flex items-center justify-center shadow-sm border border-gray-300 dark:border-[#333]'>
              <Typography.Text className='text-gray-700 dark:text-gray-300 text-xs font-bold'>
                S
              </Typography.Text>
            </div>
            <Typography.Text className='text-gray-700 dark:text-gray-300 text-xs sm:text-sm font-medium'>
              {t('系统消息')}
            </Typography.Text>
          </div>
        </div>
