    ...
    <Tabs
      ...
      tabBarExtraContent={
        <Button
          type='primary'
          size='small'
          className='!h-10 !rounded-2xl !border-0 !bg-white/90 hover:!bg-white/80 !px-4 !text-black'
              ...
              <span className='flex items-center gap-2'>
                ...
                >
                  <Button
                    ...
                    type='tertiary'
                    theme='outline'
                    className='!rounded-xl !border !border-white/10 !bg-white/6 !text-white hover:!bg-white/10'
