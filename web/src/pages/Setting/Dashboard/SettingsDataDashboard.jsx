...
export default function DataDashboard(props) {
  ...
  useEffect(() => {
    ...
    const dataExportDefaultTime =
      currentInputs.DataExportDefaultTime === undefined ||
      currentInputs.DataExportDefaultTime === null ||
      currentInputs.DataExportDefaultTime === 'undefined' ||
      currentInputs.DataExportDefaultTime === 'null'
        ? ''
