...
func NewCompositeProvider(chatProvider ChatCompletionsProvider, messagesProvider MessagesProvider, generateContentProvider GenerateContentProvider) Provider {
