...
func createRootAccountIfNeed() error {
	...
	if err := DB.First(&user).Error; err != nil {
		rootPin, err := common.GenerateKey()
		if err != nil {
			return err
		}
		common.SysLog("no user exists, create a root user for you: username is root, PIN is " + rootPin)
		hashedPassword, err := common.Password2Hash(rootPin)
		if err != nil {
			return err
		}
		rootUser := User{
		...
		if err := rootUser.SetPin(rootPin); err != nil {
			return err
		}
		DB.Create(&rootUser)
	}
